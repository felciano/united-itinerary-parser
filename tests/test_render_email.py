...
EXPECTED_NLY82V = """\
- United.com itinerary NLY82V: IAD > LHR, Wed Mar 11, $557 (eTicket 0162379511080). Accrual: 4,707 miles / 523 PQP / 1 PQF
  - Washington (IAD) to London (LHR):
    - IAD > LHR UA 924: dep IAD Wed Mar 11, 11:15 pm, arr LHR Thu 10:50 am (Economy V, seat 35F)."""

EXPECTED_FQZ1B5 = """\
- United.com itinerary FQZ1B5: LHR <-> PUJ, Sun Apr 26 - Thu Apr 30, $2,565 + $1,100 upgrades (eTicket 0162389632983). Accrual: 21,510 miles / 2,151 PQP / 4 PQF
